...
@Pattern(regexp="^[_.@A-Za-z0-9-]*$") @Size(min=1,max=50) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activated, authorities, createdBy, createdDate, email, firstName, id, imageUrl, langKey, lastModifiedBy, lastModifiedDate, lastName, login, phonenumber);
  }
